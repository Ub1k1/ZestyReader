...
class UI:
    ...
    def run(self):
        ...
        play_button = Button(text="Play", image=play_image, compound=LEFT, width=60, height=24, command=self.buttonFunctions.play_text(text=text, voice_speed=voice_speed, voice_type_combo=voice_type_combo))
